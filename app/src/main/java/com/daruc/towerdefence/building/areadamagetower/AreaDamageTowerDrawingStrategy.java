...
public class AreaDamageTowerDrawingStrategy extends BuildingDrawingStrategy {
    public AreaDamageTowerDrawingStrategy(Building building) {
        super(building);
    }
    ...
    public void draw(Canvas canvas, MapView mapView) {
        ...
        paint.setColor(Color.argb(255, 22, 144, 43));
